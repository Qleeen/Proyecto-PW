          ...
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                <form action="{{ route('enviarLogin') }}" method="POST">
                  @csrf
                  ...
                  <div class="form-outline mb-4">
                    <input type="email" name="txtemail" value="{{ old('txtemail') }}" class="form-control form-control-lg" placeholder="Correo Electrónico">
                  ...
                  <!-- Contraseña -->
                  <div class="form-outline mb-4">
                    <input type="password" name="txtpassword" class="form-control form-control-lg" placeholder="Contraseña">
                  ...
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">¿No tienes cuenta? 
                    <a href="{{ route('rutaregistro') }}" style="color: #393f81;">Regístrate aquí</a>
                  </p>
                </form>
              </div>
            </div>
